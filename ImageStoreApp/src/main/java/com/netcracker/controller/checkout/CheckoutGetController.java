...
public class CheckoutGetController {
	...
	/**
	 * forms checkout template basing on session's cart, address and billing information
	 * 
	 * @param cartId               current session user's cart ID
	 * @param missingRequiredField flag showing that some of form's mandatory attributes are empty 
