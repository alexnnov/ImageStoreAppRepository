...
public class UserController {
	...
	/**
	 * processes request from myAccount template for creating new regular user basing on email
	...
	public String newUserPost(HttpServletRequest request, @ModelAttribute("email") String userEmail,
		...
		userRoles.add(new UserRole(user, Role.REGULAR_USER_ROLE));
	...
	/**
	 * authenticates user basing on provided password reset token
	 * 
	...
	/**
	 * updates user personal information and password basing on provided
	 * 
	...
	public String updateUserInfo(@ModelAttribute("user") User user, @ModelAttribute("newPassword") String newPassword,
		...
		Long userIdFoundByEmail = userService.findByEmail(user.getEmail()).getId();
		Long userIdFoundByUsername = userService.findByUsername(user.getUsername()).getId();

		if (userIdFoundByEmail != null && !currentUser.getId().equals(userIdFoundByEmail)) {
			model.addAttribute("emailExists", true);
			return "myProfile";
		}

		if (userIdFoundByUsername != null && !userIdFoundByUsername.equals(currentUser.getId())) {
			model.addAttribute("usernameExists", true);
